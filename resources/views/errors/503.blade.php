...
@section('code', '404')
@section('message', __('Walaah Nggak Ketemu ya !!!')) --}}
{{-- @extends('errors::minimal')
    ...
    <div class="md:flex min-h-screen">
        <div class="w-full md:w-1/2 bg-white flex items-center justify-center ">
            <div class="max-w-sm m-8">
                ...
                <p class="text-grey-darker text-2xl md:text-3xl font-light mb-8 leading-normal">Wadduh, Server Full.
                    Antri Sebentar ya Mas Mbak, Jangan Panik. Boleh Ngopi wkwk - Maklum Server MURAH !!!</p>
                <a href="/login">
                    <button
